...
function sendEmail() {
  ...
  let body = "Tên khách hàng: " + useNames + "<br/> Số điện thoại: " + numberPhone + "</br> Tên gmail của quý khách" + email + "</br> Số lượng khách hàng" + qualitys + "</br> Thời gian đến: " times +  date + messages ;
