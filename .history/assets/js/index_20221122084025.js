...
function sendEmail() {
  ...
  let body = "<big>Tên khách hàng: </b>" + useNames + "<br/> Số điện thoại: " + numberPhone + "<br/> Tên gmail của quý khách: " + email + "<br/> Số lượng khách hàng" + qualitys + "<br/> Thời gian đến: " + times + "<br/> Ngày đến: " + date + "<br/> Yêu cầu của quý khách: " + messages ;
