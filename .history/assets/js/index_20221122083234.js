...
function sendEmail() {
  ...
  let body = "Tên khách hàng: " + useNames + "<br/> Số điện thoại: " + numberPhone + "</br> Tên gmail của quý khách" + email + "</br> Số lượng khách hàng" + qualitys + "</br> Thời gian đến: " + times + "</br> Ngày đến: " + date + "</br> " messages ;

  // let body :  "Tên khách hàng: " +  useNames +  "Số điện thoại: " + numberPhone +  "Tên gmail của quý khách: " + email + "Số lượng khách hàng: " + qualitys +  "Thời gian đặt bàn: " + times + "Ngày đặt bàn: " + date + "Yêu cầu của khách hàng: " + messages;
