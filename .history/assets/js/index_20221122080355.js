...
function sendEmail() {
  let useNames = document.getElementById("useNames").value;
  ...
  // let body = useNames + numberPhone + email + qualitys + times + date + messages ;

  let bodys : 
  Tên khách hàng: ${useNames} <br>  Số điện thoại: ${numberPhone} <br>  Tên gmail của quý khách: ${email} <br> Số lượng khách hàng: ${qualitys} <br>  Thời gian đặt bàn: ${times} <br> Ngày đặt bàn: ${date} <br> Yêu cầu của khách hàng: ${messages};
