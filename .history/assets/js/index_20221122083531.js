...
function sendEmail() {
  ...
  let body = "Tên khách hàng: " + useNames + "Số điện thoại: " + numberPhone + "Tên gmail của quý khách: " + email + "Số lượng khách hàng" + qualitys + "Thời gian đến: " + times + "Ngày đến: " + date + "Yêu cầu của quý khách: " + messages ;
